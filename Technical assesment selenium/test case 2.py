...
driver.get('https://commerceos.staging.devpayever.com/registration/santandar')
...
industry = driver.find_element(By.XPATH, '//*[@id="layout-container"]/div/entry-default-business-registration/entry-create-business-form/form/peb-form-background/div/pe-autocomplete/div/peb-form-field-input/div/div[1]/span').click()
time.sleep(0.4)
mat_option = driver.find_element(By.XPATH, '//*[@id="mat-option-2"]').click()
...
apps = 'Transactions, Checkout, Connect, Point of Sale, Settings'.lower().split(', ')
time.sleep(3)
